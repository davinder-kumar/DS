...
class Linkedlist extends Component {
    ...
    onChangeHandler = (event) => {
        ...
        let updateNodeForm = { ...this.state.nodeForm }
        let updateElement = { ...updateNodeForm.node }
        updateElement.value = val
        updateNodeForm.node = updateElement
        this.setState({
            nodeForm: updateNodeForm
        })
