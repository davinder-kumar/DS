...
class Linkedlist extends Component {
    ...
    render() {
        ...
        let formData = form.map(element => {
            return <Input type={element.data.elementType} onChangeHandler={this.onChangeHandler} 
            label="Add Node" value={element.data.value} elementConfig={element.data.elementConfig} key={element.id} />
        })
